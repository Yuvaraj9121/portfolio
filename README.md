...
Put your photo in this folder with the exact filename `profile.jpg`:

`c:\Users\admin\Desktop\projects\profile.jpg`

It will appear automatically in the hero section when anyone opens the portfolio.
